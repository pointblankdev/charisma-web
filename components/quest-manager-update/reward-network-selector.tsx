...
export function RewardNetworkSelector({ models, types, ...props }: ModelSelectorProps) {
    ...
    <div className="grid gap-2">
      <HoverCard openDelay={200}>
        <HoverCardTrigger asChild>
          <Label htmlFor="model">Reward Network</Label>
        </HoverCardTrigger>
        <HoverCardContent align="start" className="w-[260px] text-sm" side="left">
          The network which will track the quest completion. You can issue rewards on any network
