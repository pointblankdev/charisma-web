...
const UnstakeLeoButton: FC<UnstakeLeoButtonProps> = ({ tokens }) => {
    ...
    doContractCall({
      ...
      postConditions: [
        Pc.principal(sender)
          ...
          .ft('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-leo', 'liquid-staked-token'),
        Pc.principal('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-leo')
          .willSendGte(tokensOutMin)
          .ft('SP1AY6K3PQV5MRT6R4S671NWW2FRVPKM0BR162CT6.leo-token', 'leo')
      ],
      onFinish: data => {
