...
interface StakeGusButtonProps {
  tokens: string;
}

const StakeGusButton: FC<StakeGusButtonProps> = ({ tokens }) => {
    ...
    doContractCall({
      ...
      postConditions: [
        Pc.principal(sender)
          ...
          .ft('SP1JFFSYTSH7VBM54K29ZFS9H4SVB67EA8VT2MYJ9.gus-token', 'gus')
      ],
      onFinish: data => {
  ...
  return (
    ...
    >
      Stake {tokens && tokens6Dec > 0 ? millify(Number(tokens)) : 0} GUS
    </Button>
  );
};

export default StakeGusButton;
