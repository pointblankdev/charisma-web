    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger className="w-full">
          <Button
            disabled={tokensToClaim === 0 || !isGuestlisted}
        ...
        >
          <div>
            Access to this faucet is limited to guestlist members. Guestlists are curated through
            community voting, ensuring all members contribute meaningfully to the project.
          </div>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
