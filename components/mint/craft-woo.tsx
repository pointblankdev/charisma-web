...
const CraftWoo = ({ amount }: { amount: number }) => {
  ...
  function craft() {
    ...
    doContractCall({
      ...
      postConditions: [
        // unstake
        Pc.principal('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-welsh')
          .willSendLte(amount * 100)
          .ft('SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token', 'welshcorgicoin'),
        Pc.principal('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-roo')
          .willSendLte(amount)
        ...
        Pc.principal(sender)
          .willSendLte(amount * 100)
          .ft('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-roo', 'liquid-staked-roo')
      ],
      onFinish: data => {
