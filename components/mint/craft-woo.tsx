...
const CraftWoo = ({ amount }: { amount: number }) => {
  ...
  function craft() {
    ...
    doContractCall({
      ...
      postConditions: [
        Pc.principal(sender).willSendLte(amount * 10000).ft("SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token", 'welshcorgicoin'),
        Pc.principal(sender).willSendLte(amount * 42).ft("SP2C1WREHGM75C7TGFAEJPFKTFTEGZKF6DFT6E2GE.kangaroo", 'kangaroo'),
      ],
      onFinish: (data) => {
