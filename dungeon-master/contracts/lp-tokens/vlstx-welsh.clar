...
;; vlSTX-WELSH LP token with configurable metadata
...
(define-data-var token-symbol (string-ascii 10) "vlSTX-WELSH")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/vlstx-welsh/metadata.json"))
