...
(define-data-var token-name (string-ascii 32) "STX-CHA LP Token")
(define-data-var token-symbol (string-ascii 10) "STX-CHA")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/stx-cha/metadata.json"))
