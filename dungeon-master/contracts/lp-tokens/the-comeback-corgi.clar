;; The Comeback Corgi
;; vSTX-(CHA-iouWELSH) LP token with configurable metadata
...
(define-data-var token-name (string-ascii 32) "The Comeback Corgi")
(define-data-var token-symbol (string-ascii 10) "tCC")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/the-comeback-corgi/metadata.json"))
