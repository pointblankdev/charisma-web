;; vWELSH-UPDOG LP token
;;
;; This LP token represents a virtualized WELSH-DOG position,
;; using virtual WELSH and UPDOG as the underlying assets.
...
(define-data-var token-name (string-ascii 32) "Virtual Updog")
(define-data-var token-symbol (string-ascii 10) "vUPDOG")
(define-data-var token-uri (optional (string-utf8 256)) 
  (some u"https://charisma.rocks/sip10/virtual-updog/metadata.json"))
