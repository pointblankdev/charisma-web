...
(define-public (get-quote-a
    ...
    (charisma-tokens (tuple (a <ft-trait>) (b <ft-trait>)))
  )
  (let (
    ...
    (quote-a (try! (if (is-eq swaps-reversed false)
                       ...
                       (charisma-quote-a amount charisma-tokens))))
    (quote-b (try! (if (is-eq swaps-reversed false)
                       (charisma-quote-a quote-a charisma-tokens)
...
(define-public (get-quote-b
    ...
    (xyk-tokens (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>)))
    (xyk-pools (tuple (a <xyk-pool-trait>)))
    (charisma-tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>)))
  )
  (let (
    ;; Assert that swap-status is true and amount is greater than 0
    (swap-status-check (asserts! (is-eq (var-get swap-status) true) ERR_SWAP_STATUS))
    ...
    (quote-a (try! (if (is-eq swaps-reversed false)
                       (xyk-quote-a amount xyk-tokens xyk-pools)
                       (charisma-quote-b amount charisma-tokens))))
    (quote-b (try! (if (is-eq swaps-reversed false)
                       (charisma-quote-b quote-a charisma-tokens)
                       (xyk-quote-a quote-a xyk-tokens xyk-pools))))
  )
    ;; Return number of tokens the caller would receive
    (ok quote-b)
...
(define-public (get-quote-c
    ...
    (xyk-tokens (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>)))
    (xyk-pools (tuple (a <xyk-pool-trait>)))
    (charisma-tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>)))
  )
  (let (
    ;; Assert that swap-status is true and amount is greater than 0
    (swap-status-check (asserts! (is-eq (var-get swap-status) true) ERR_SWAP_STATUS))
    ...
    (quote-a (try! (if (is-eq swaps-reversed false)
                       (xyk-quote-a amount xyk-tokens xyk-pools)
                       (charisma-quote-c amount charisma-tokens))))
    (quote-b (try! (if (is-eq swaps-reversed false)
                       (charisma-quote-c quote-a charisma-tokens)
                       (xyk-quote-a quote-a xyk-tokens xyk-pools))))
  )
    ;; Return number of tokens the caller would receive
    (ok quote-b)
...
(define-public (get-quote-d
    ...
    (xyk-tokens (tuple (a <xyk-ft-trait>) (b <xyk-ft-trait>)))
    (xyk-pools (tuple (a <xyk-pool-trait>)))
    (charisma-tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>) (e <ft-trait>)))
  )
  (let (
    ;; Assert that swap-status is true and amount is greater than 0
    (swap-status-check (asserts! (is-eq (var-get swap-status) true) ERR_SWAP_STATUS))
    ...
    (quote-a (try! (if (is-eq swaps-reversed false)
                       (xyk-quote-a amount xyk-tokens xyk-pools)
                       (charisma-quote-d amount charisma-tokens))))
    (quote-b (try! (if (is-eq swaps-reversed false)
                       (charisma-quote-d quote-a charisma-tokens)
                       (xyk-quote-a quote-a xyk-tokens xyk-pools))))
  )
    ;; Return number of tokens the caller would receive
    (ok quote-b)
...
;; Perform swap via XYK Core and Charisma
(define-public (swap-helper-a
    ...
    (xyk-pools (tuple (a <xyk-pool-trait>)))
    (charisma-tokens (tuple (a <ft-trait>) (b <ft-trait>)))
    (charisma-share-fee-to <share-fee-to-trait>)
  )
  (let (
    ;; Assert that swap-status is true and amount is greater than 0
    (swap-status-check (asserts! (is-eq (var-get swap-status) true) ERR_SWAP_STATUS))
    ...
    (swap-a (if (is-eq swaps-reversed false)
                ...
                (try! (charisma-swap-a amount charisma-tokens charisma-share-fee-to))))
    (swap-b (if (is-eq swaps-reversed false)
                (try! (charisma-swap-a swap-a charisma-tokens charisma-share-fee-to))
    ...
    (begin
      ...
      (print {
        ...
        data: {
          ...
          charisma-data: {
            charisma-tokens: charisma-tokens,
            charisma-share-fee-to: charisma-share-fee-to,
            charisma-swaps: {
...
(define-public (swap-helper-b
  ...
  (let (
    ...
    (swap-a (if (is-eq swaps-reversed false)
                (try! (xyk-swap-a amount xyk-tokens xyk-pools))
                (try! (charisma-swap-b amount charisma-tokens charisma-share-fee-to))))
    (swap-b (if (is-eq swaps-reversed false)
                (try! (charisma-swap-b swap-a charisma-tokens charisma-share-fee-to))
                (try! (xyk-swap-a swap-a xyk-tokens xyk-pools))))
  )
    (begin
      ;; Assert that swap-b is greater than or equal to min-received
...
(define-public (swap-helper-c
  ...
  (let (
    ...
    (swap-a (if (is-eq swaps-reversed false)
                (try! (xyk-swap-a amount xyk-tokens xyk-pools))
                (try! (charisma-swap-c amount charisma-tokens charisma-share-fee-to))))
    (swap-b (if (is-eq swaps-reversed false)
                (try! (charisma-swap-c swap-a charisma-tokens charisma-share-fee-to))
                (try! (xyk-swap-a swap-a xyk-tokens xyk-pools))))
  )
    (begin
      ;; Assert that swap-b is greater than or equal to min-received
...
(define-public (swap-helper-d
  ...
  (let (
    ...
    (swap-a (if (is-eq swaps-reversed false)
                (try! (xyk-swap-a amount xyk-tokens xyk-pools))
                (try! (charisma-swap-d amount charisma-tokens charisma-share-fee-to))))
    (swap-b (if (is-eq swaps-reversed false)
                (try! (charisma-swap-d swap-a charisma-tokens charisma-share-fee-to))
                (try! (xyk-swap-a swap-a xyk-tokens xyk-pools))))
  )
    (begin
      ;; Assert that swap-b is greater than or equal to min-received
...
;; Get swap quote via Charisma using two tokens
(define-private (charisma-quote-a
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>)))
  )
  (let (
    (quote-result (contract-call?
                  'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-path2 amount-out
                  amount
                  (get a tokens) (get b tokens)))
  )
    (ok quote-result)
...
;; Get swap quote via Charisma using three tokens
(define-private (charisma-quote-b
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>)))
  )
  (let (
    (quote-result (contract-call?
                  'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-path2 get-amount-out-3
                  amount
...
;; Get swap quote via Charisma using four tokens
(define-private (charisma-quote-c
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>)))
  )
  (let (
    (quote-result (contract-call?
                  'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-path2 get-amount-out-4
                  amount
...
;; Get swap quote via Charisma using five tokens
(define-private (charisma-quote-d
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>) (e <ft-trait>)))
  )
  (let (
    (quote-result (contract-call?
                  'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-path2 get-amount-out-5
                  amount
                  (get a tokens) (get b tokens) (get c tokens)
...
;; Perform swap via Charisma using two tokens
(define-private (charisma-swap-a
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>)))
  ...
  (let (
    (swap-result (try! (contract-call?
                       'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-path2 do-swap
                       amount
                       (get a tokens) (get b tokens)
                       share-fee-to)))
  )
...
;; Perform swap via Charisma using three tokens
(define-private (charisma-swap-b
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>)))
    (share-fee-to <share-fee-to-trait>)
  )
...
;; Perform swap via Charisma using four tokens
(define-private (charisma-swap-c
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>)))
    (share-fee-to <share-fee-to-trait>)
  )
...
;; Perform swap via Charisma using five tokens
(define-private (charisma-swap-d
    (amount uint)
    (tokens (tuple (a <ft-trait>) (b <ft-trait>) (c <ft-trait>) (d <ft-trait>) (e <ft-trait>)))
    (share-fee-to <share-fee-to-trait>)
  )
