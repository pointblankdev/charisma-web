...
const ExecuteStrategy = () => {
  ...
  const amountOutMinA = Number((amountIn * 0.4).toFixed(0))
  const amountOutMinB = Number((amountIn * 0.4).toFixed(0))
  ...
  function swap() {
    doContractCall({
      ...
      contractName: 'icc-arb-bear-trap',
      functionName: "execute-strategy",
      functionArgs: [uintCV(amountIn), uintCV(amountOutMinA), uintCV(amountOutMinB)],
