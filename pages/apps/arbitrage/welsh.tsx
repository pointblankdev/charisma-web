...
export default function Swap({ data }: Props) {
  ...
  const [swapConfig, setSwapConfig] = useState<SwapConfig>({
    steps: [
      {
        fromToken: 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token',
        fromAmount: 100000,
        action: 'SWAP',
      ...
      },
      {
        ...
        fromAmount: 0,
        action: 'SWAP',
        toToken: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-welsh-v2',
        toAmount: 0
      },
      {
        fromToken: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.liquid-staked-welsh-v2',
        fromAmount: 0,
        action: 'UNSTAKE',
        toToken: 'SP3NE50GEXFG9SZGTT51P40X2CKYSZ5CC4ZTZ7A2G.welshcorgicoin-token',
        toAmount: 0
      }
    ],
    options: {
        ...
        >
          ...
          >
            ...
            <div className="text-center text-xs m-2 text-secondary/50">
              *If your trade is profitable, a small portion of earnings are deposited in the Velar
              STX-sCHA LP. This LP remains yours.
            </div>
          </SwapContext.Provider>
