...
const MicroDeposit = () => {
  ...
  function deposit() {
    doContractCall({
      ...
      functionArgs: [uintCV(7000000000000000), principalCV('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS'), principalCV('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.battle-royale-v2'), noneCV()],
