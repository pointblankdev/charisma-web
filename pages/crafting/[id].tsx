                                        ...
                                        <Tooltip>
                                            <TooltipTrigger>
                                                <div className='relative'>
                                                    ...
                                                    {Math.abs(tokensRequested) !== 0 && <div className='absolute px-1 font-bold rounded-full -top-1 -right-3 text-md md:text-base lg:text-sm bg-accent text-accent-foreground'>{millify(Math.abs(tokensRequested))}</div>}
                                                </div>
                                            </TooltipTrigger>
                                                ...
                                                <Tooltip>
                                                    <TooltipTrigger>
                                                        <div className='z-20 relative'>
                                                            ...
                                                            {Math.abs(tokensRequired[k]) !== 0 && <div className='absolute px-1 font-bold rounded-full -top-1 -right-3 text-md md:text-base lg:text-sm bg-accent text-accent-foreground'>{millify(Math.abs(tokensRequired[k]))}</div>}
                                                        </div>
                                                    </TooltipTrigger>
                                                    <TooltipContent side='bottom' className={`text-md max-h-[80vh] overflow-scroll bg-black text-white border-primary leading-tight shadow-2xl max-w-prose`}>
