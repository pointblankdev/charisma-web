...
export default function Tokenomics({ data }: Props) {
  ...
  const mergedWalletBalances = map(walletBalances, obj1 => {
    const obj2 = find(wallets, { stxaddress: obj1.primary });
      ...
      <Layout>
        <div className="m-2 sm:container sm:mx-auto sm:py-10 space-y-4">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="bg-black text-primary-foreground border-accent-foreground">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Drip Amount</CardTitle>
          ...
          <p className="mb-4 font-light">
            The Charisma Token operates within a unique economic model designed for transparency,
            controlled distribution, and a self-sustaining ecosystem.
          </p>

          <ol className="list-decimal pl-5 font-extralight">
            <li className="mb-3">
              <b className="font-semibold">Token Faucet Mechanism</b>: At the heart of the DAO's
              tokenomics is the Charisma Token Faucet. This system drips or mints Charisma tokens
              over a set period. The rate, known as the "drip amount," defines the number of tokens
              released per blockchain block. This drip mechanism ensures a steady and predictable
              token supply growth, giving users and investors a clear view of issuance.
            </li>

            <li className="mb-3">
              <b className="font-semibold">Claiming Tokens</b>: Users have the opportunity to claim
              tokens from the faucet. The amount claimable is a product of the drip rate and the
              number of blocks since the last claim. This system not only promotes user interaction
              but also ensures a decentralized distribution of tokens over time.
            </li>

            <li className="mb-3">
              <b className="font-semibold">Controlled Issuance</b>: While users can claim tokens,
              the drip amount or rate of token issuance can only be adjusted by the DAO or its
              authorized extensions. This provision preserves the integrity of the tokenomics,
              ensuring no unauthorized or unpredictable supply surges.
            </li>

            <li className="mb-3">
              <b className="font-semibold">Transparency & Security</b>: All token issuance and
              transactions are recorded on the blockchain, offering a transparent audit trail.
              Moreover, measures are in place to prevent any abuse, like unauthorized changes to the
              drip amount or claims when insufficient balance is available.
            </li>
          </ol>

          <p className="mt-4 font-light">
            In essence, this approach emphasizes a stable growth model, transparency, and
            user-centric distribution, aiming to build trust, value, and a strong community
            foundation.
          </p>
