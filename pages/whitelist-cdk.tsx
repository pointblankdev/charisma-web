...
export default function WhitelistCDKPage() {
    const meta = {
        title: 'Charisma | Whitelist CDK',
...
const WhitelistCDK = () => {
    ...
    const [edkContractAddress, setCDKContractAddress] = useState('SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.land-helper-v3');
    ...
    function setExtension() {
        openContractCall({
            ...
            functionName: "set-whitelisted-cdk",
        ...
        <>
            <div className='flex items-center'>
                <div className='w-full items-stretch'>
                    ...
                    <Input onChange={e => setCDKContractAddress(e.target.value)} className='w-full' placeholder='ContractAddress' />
                </div>
                <Checkbox onCheckedChange={e => setWhitelist(e as any)} className='w-16 h-16 m-2'>Whitelist</Checkbox>
            </div>
            <Button className='text-md w-full hover:bg-[#ffffffee] hover:text-primary' onClick={setExtension}>Whitelist CDK</Button>
        </>
    );
};