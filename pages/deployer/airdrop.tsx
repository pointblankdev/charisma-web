...
export default function ContractEditor({ quest }: any) {
    ...
    const deployContract = ({ name, description }: any) => {
    ...
    return (
        <Layout>
            <div className="my-4 space-y-4 sm:container sm:mx-auto sm:py-10 md:max-w-4xl lg:max-w-7xl">
                <h1 className="text-2xl font-bold mx-8">Airdrop Tokens to STX Addresses</h1>
                <Form {...form}>
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="w-full">
                                            <FormLabel>Airdrop Contract Name</FormLabel>
                                            <FormControl>
