...
const Card: FC<CardProps> = ({ href, src, alt, title, subtitle }) => (
  <Link
    href={href}
    className={cn(
      'w-full',
  ...
  >
    <div className="overflow-hidden rounded-md">
      <Image
        ...
        width={600}
        className={cn(
          'h-auto w-auto object-cover transition-all group-hover/card:scale-[120%]',
          'aspect-[3/4]'
        )}
      />
    </div>
      ...
      <Layout>
        <div className="m-2 sm:container sm:mx-auto sm:py-10">
          <Tabs defaultValue="proposals" className="">
            ...
            <Link href="/governance/guide" className="float-right">
