            ...
            <CardContent className="z-20 flex-grow p-4 space-y-4">
              <section className='grid grid-cols-2'>
                ...
                <div className="z-20 row-span-2">
                  ...
                  <div className="z-30 mb-4 text-sm font-fine text-foreground">
                    If defeated, everyone who contributed to the battle receives rewards. Experience is divide up evenly, and CHA tokens are split based on damage dealt to Hogger.
                  </div>
                </div>
