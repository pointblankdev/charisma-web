...
export default function MemeEngineAPI(
    ...
    return res.status(200).json({
        ...
        name: `Meme Engine (iouROO)`,
        subtitle: 'Generate energy by holding Synthetic Roo tokens.',
        description: [
            "The Synthetic Roo Meme Engine works by tracking your token balance across time. When you execute the TAP action, the contract calculates your average balance since your last tap. The resulting energy generation accurately reflects the average monetary value of your held balances, with more points sampled during longer periods for greater accuracy.",
