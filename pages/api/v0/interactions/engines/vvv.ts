...
export default async function MemeEngineAPI(
  ...
  return res.status(200).json({
    url: `https://charisma.rocks/interactions/engines/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.veni-vidi-vici-rc1`,
    image: `https://charisma.rocks/interactions/engines/vvv.png`,
    name: `Veni Vidi Vici (VVV)`,
    analytics: await EnergyMetricsService.getMetricsByContractId(
      `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.veni-vidi-vici-rc1`
    ),
    subtitle: 'Generate energy by holding Veni Vidi Vici tokens.',
    description: [
      'The Veni Vidi Vici Meme Engine works by tracking your token balance across time. When you execute the TAP action, the contract calculates your average balance since your last tap. The resulting energy generation accurately reflects the average monetary value of your held balances, with more points sampled during longer periods for greater accuracy.',
    ...
    contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.veni-vidi-vici-rc1`,
