...
export default function MemeEngineAPI(
    ...
    return res.status(200).json({
        url: `https://charisma.rocks/interactions/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-iou-welsh-rc1`,
        image: `https://charisma.rocks/interactions/engines/iou-welsh.png`,
        name: `Meme Engine (iouWELSH)`,
        subtitle: 'Generate energy by holding Synthetic Welsh tokens.',
        description: [
            "The Synthetic Welsh Meme Engine works by tracking your token balance across time. When you execute the TAP action, the contract calculates your average balance since your last tap. The resulting energy generation accurately reflects the average monetary value of your held balances, with more points sampled during longer periods for greater accuracy.",
        ...
        contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-iou-welsh-rc1`,
        category: 'Engines',
        actions: ['TAP']
    });
}
