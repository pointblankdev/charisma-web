...
export default function MemeEngineAPI(
    ...
    return res.status(200).json({
        url: `https://charisma.rocks/interactions/engines/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-iou-welsh-rc3`,
        image: `https://charisma.rocks/interactions/engines/iou-welsh.png`,
        name: `Synthetic Welsh (iouWELSH)`,
        apy: 100,
        ...
        contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-iou-welsh-rc3`,
