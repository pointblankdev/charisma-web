...
export default async function MemeEngineAPI(
    ...
    return res.status(200).json({
        ...
        name: `Charisma (CHA)`,
        analytics: await EnergyMetricsService.getMetricsByContractId(`SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-cha-rc6`),
        ...
        contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-cha-rc6`,
