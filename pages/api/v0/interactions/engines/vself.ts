...
export default async function MemeEngineAPI(
  ...
  return res.status(200).json({
    url: `https://charisma.rocks/interactions/engines/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.virtual-self-rc1`,
    ...
    analytics: await EnergyMetricsService.getMetricsByContractId(
      `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.virtual-self-rc1`
    ),
    ...
    contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.virtual-self-rc1`,
