...
export default function MemeEngineAPI(
    ...
    return res.status(200).json({
        url: `https://charisma.rocks/interactions/engines/SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-cha-iou-welsh-rc1`,
        image: `https://charisma.rocks/interactions/engines/cha-iou-welsh.png`,
        name: `Charisma - Synthetic Welsh LP`,
        apy: 100,
        subtitle: 'Generate energy by holding CHA-iouWELSH LP tokens.',
        description: [
            "The CHA-iouWELSH Hold-to-Earn engine works by tracking your token balance across time. When you execute the TAP action, the contract calculates your average balance since your last tap. The resulting energy generation accurately reflects the average monetary value of your held balances, with more points sampled during longer periods for greater accuracy.",
        ...
        contract: `SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine-cha-iou-welsh-rc1`,
