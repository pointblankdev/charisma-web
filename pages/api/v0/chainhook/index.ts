...
const hook = new Webhook(
  'https://discord.com/api/webhooks/1144890336594907146/BtXYwXDuHsWt6IFMOylwowcmCUWjOoIM6MiqdIBqIdrbT5w_ui3xdxSP2OSc2DhlkDhn'
);
      ...
      for (const tx of a.transactions) {
        try {
          if (tx.metadata.success) {
            ...
            builder.setAuthor({
              name: `Charisma Event`,
              icon_url: 'https://charisma.rocks/dmg-logo.png',
              url: 'https://charisma.rocks/players'
            });
