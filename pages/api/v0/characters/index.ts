...
async function handleCreateCharacter(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const characterAddress = getStxAddress({
...
async function handleGetCharacters(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const filteredCharacters =
      includeArchived === 'true' ? characters : characters.filter(c => !c.archived);
...
async function handleArchiveCharacter(req: NextApiRequest, res: NextApiResponse) {
  try {
