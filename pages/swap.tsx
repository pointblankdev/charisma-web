...
export const getStaticProps: GetStaticProps<Props> = async () => {
  ...
  const poolInfo = cvToValue(response).value.pool;
...
const SwapInterface = ({
  ...
  const synStx = getBalanceByKey(
    'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-stx::synthetic-stx'
  );
          ...
          <div className="mb-2 space-y-4">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <div>
                  <span className="mr-2 text-gray-400">
                    Balance: {formatBalance(getBalance(fromToken.symbol), fromToken.decimals)}
                  </span>
                  <button
            ...
            <div className="p-4 rounded-lg shadow-xl shadow-primary/10 border border-t-0 border-x-0 border-b-[var(--accents-7)]">
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <span className="text-gray-400">
                  Balance: {formatBalance(getBalance(toToken.symbol), toToken.decimals)}
                </span>
              </div>
            </div>
