...
import StakeOdinButton from '@components/stake/stake-odin';
import UnstakeOdinButton from '@components/stake/unstake-odin';
...
export default function StakeOdin({ data }: Props) {
  ...
  const meta = {
    title: 'Charisma | Stake Odin Tokens',
    description: META_DESCRIPTION,
    image: '/liquid-odin.png'
  };
      ...
      <Layout>
        <div className="m-2 sm:container sm:mx-auto sm:py-10 md:max-w-2xl">
          ...
          <Card className='p-0 overflow-hidden bg-black text-primary-foreground border-accent-foreground rounded-xl'>
            <Image alt='Liquid Odin' src={liquidOdin} width="1080" height="605" className='border-b border-accent-foreground' />
            <div className='m-2'>
