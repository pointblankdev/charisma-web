...
import StakeMaxButton from '@components/stake/stake-max';
import UnstakeMaxButton from '@components/stake/unstake-max';
...
export default function Stake({ data }: Props) {
  ...
  const meta = {
    title: 'Charisma | Stake Max Tokens',
    description: META_DESCRIPTION,
    image: '/liquid-max.png'
  };
      ...
      <Layout>
        <div className="m-2 sm:container sm:mx-auto sm:py-10 md:max-w-2xl">
          ...
          <Card className='p-0 overflow-hidden bg-black text-primary-foreground border-accent-foreground rounded-xl'>
            <Image alt='Liquid Max' src={liquidMax} width="1080" height="605" className='border-b border-accent-foreground' />
            <div className='m-2'>
              <div className='flex justify-between mb-2'>
                <h1 className="self-center font-bold text-md sm:text-2xl">Liquid Staked Max</h1>
                {data.exchangeRate && <div className="self-center px-2 my-1 text-xs font-light text-center rounded-full sm:text-lg sm:p-0 sm:px-4">
                  <div className="self-center px-2 my-1 text-xs font-light text-center rounded-full sm:text-lg bg-primary sm:p-0 sm:px-4">1 sMAX = {Number(data.exchangeRate) / 1000000} MAX</div>
                </div>}
              </div>
              ...
              <div className='flex justify-between'>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className='max-w-2xl leading-tight text-white bg-black border-primary'>
                      ...
                      <ul className="pl-5 mb-4 space-y-2 list-disc text-md">
                        <li>
                          <b>Stake Tokens</b>: Stake your Max tokens to receive Liquid Staked Max (sMAX). The amount of sMAX you receive is calculated based on the current inverse exchange rate.
                        </li>
                        <li>
                          <b>Unstake Tokens</b>: Redeem your sMAX for Max tokens based on the current exchange rate.
                        </li>
                      </ul>
                      <p className="mb-4">
                        Staking your Max tokens allows you to participate in governance and earn staking rewards generated from network activities. Your staked tokens help secure the network and in return, you earn more tokens over time.
                      </p>
                      <p className="mb-4">
                ...
                <div className='px-2 sm:p-0 sm:px-4'>
                  {millify(tokensInPool / 1000000)} MAX Staked
                </div>
              </div>
              <p className="mb-8 text-xs font-thin leading-tight sm:text-sm">
                Max Staking is a crucial part of the network's financial ecosystem, providing a way for token holders to earn passive income while contributing to the token's number-go-up mechanism.
              </p>
              <div className='space-y-2'>
                ...
                <div className='flex space-x-1'>
                  <StakeMaxButton tokens={tokenAmount} />
                  <UnstakeMaxButton tokens={tokenAmount} />
                </div>
              </div>
            </div>
          </Card>
