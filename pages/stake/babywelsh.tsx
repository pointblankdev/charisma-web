...
import StakeBabywelshButton from '@components/stake/stake-babywelsh';
import UnstakeBabywelshButton from '@components/stake/unstake-babywelsh';
import liquidBabywelsh from '@public/liquid-babywelsh.png'
...
export default function Stake({ data }: Props) {
  ...
  const meta = {
    title: 'Charisma | Stake Babywelsh Tokens',
    description: META_DESCRIPTION,
    image: '/liquid-babywelsh.png'
  };
          ...
          <Card className='p-0 overflow-hidden bg-black text-primary-foreground border-accent-foreground rounded-xl'>
            ...
            <div className='m-2'>
              <div className='flex justify-between mb-2'>
                <h1 className="self-center font-bold text-md sm:text-2xl">Liquid Staked Babywelsh</h1>
                {data.exchangeRate && <div className="self-center px-2 my-1 text-xs font-light text-center rounded-full sm:text-lg sm:p-0 sm:px-4">
                  <div className="self-center px-2 my-1 text-xs font-light text-center rounded-full sm:text-lg bg-primary sm:p-0 sm:px-4">1 sBABYWELSH = {Number(data.exchangeRate) / 1000000} BABYWELSH</div>
                </div>}
              </div>
              ...
              <div className='flex justify-between'>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className='leading-tight text-white bg-black babywelsh-w-2xl border-primary'>
                      ...
                      <ul className="pl-5 mb-4 space-y-2 list-disc text-md">
                        <li>
                          <b>Stake Tokens</b>: Stake your Babywelsh tokens to receive Liquid Staked Babywelsh (sBABYWELSH). The amount of sBABYWELSH you receive is calculated based on the current inverse exchange rate.
                        </li>
                        <li>
                          <b>Unstake Tokens</b>: Redeem your sBABYWELSH for Babywelsh tokens based on the current exchange rate.
                        </li>
                      </ul>
                      <p className="mb-4">
                        Staking your Babywelsh tokens allows you to participate in governance and earn staking rewards generated from network activities. Your staked tokens help secure the network and in return, you earn more tokens over time.
                      </p>
                      <p className="mb-4">
                ...
                <div className='px-2 sm:p-0 sm:px-4'>
                  {millify(tokensInPool / 1000000)} BABYWELSH Staked
                </div>
              </div>
              <p className="mb-8 text-xs font-thin leading-tight sm:text-sm">
                Babywelsh Staking is a crucial part of the network's financial ecosystem, providing a way for token holders to earn passive income while contributing to the token's number-go-up mechanism.
              </p>
