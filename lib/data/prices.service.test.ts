...
const poolsData = [
    ...
    },
    {
        id: 9,
        token0: { symbol: 'CHA', name: 'Charisma', image: '/charisma-logo-square.png', contractAddress: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.charisma-token', tokenId: 'charisma', decimals: 6 } as TokenInfo,
        token1: { symbol: 'UPDOG', name: 'Updog', image: '/sip10/up-dog/logo.gif', contractAddress: 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.up-dog', tokenId: 'lp-token', decimals: 6 } as TokenInfo,
        volume24h: 0,
...
describe('PricesService', () => {
    ...
    test('getLpTokenPriceByPoolId should throw an error for an invalid pool ID', async () => {
        ...
        await expect(PricesService.getLpTokenPriceByPoolId(invalidPoolId)).rejects.toThrow('Pool not found');
    });
