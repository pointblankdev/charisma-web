...
export const handleContractEvent = async (event: any, builder: any) => {
  ...
  if (event.type === 'STXTransferEvent') {
    ...
    if (
      contractId === 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.red-pill-nft' ||
      contractId === 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.blue-pill-nft'
    ) {
      symbol = '💊';
    ...
    if (event.data.contract_identifier === 'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.univ2-core') {
      ...
      event.data.contract_identifier.includes(
        'SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.meme-engine'
      )
    ) {
      symbol = '⚡';
